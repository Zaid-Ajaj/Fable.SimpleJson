    ...
    (function () {
        ...
        QUnit.done(function (details) {
            var banner = id("qunit-banner"),
                ...
                html = [totalTests, " tests completed in ", details.runtime, " milliseconds, with ", stats.failedTests, " failed, ", stats.skippedTests, " skipped, and ", stats.todoTests, " todo.<br /><br />", "<div><br /><br /><div><span class='passed'>", details.passed, "</span> assertions passed. </div><div> <span class='total'>", details.total, "</span> total assertions </div> <div> <span class='failed'>", details.failed, "</span> failed.</div> </div>"].join(""),
                test,
                assertLi,
                assertList;
