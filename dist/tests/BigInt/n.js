...
function BigNatModule$002EFFT$$$pow32(x, n) {
...
function BigNatModule$002EFFT$002EFp$$$mpow(x$$3, n$$1) {
  BigNatModule$002EFFT$002EFp$$$mpow: while (true) {
    if (n$$1 === 0) {
      ...
      const $n$$1$$7 = n$$1;
      const $x$$3$$6 = x$$3;
      x$$3 = (0, _Long.toInt)((0, _Long.op_Modulus)((0, _Long.op_Multiply)((0, _Long.fromInteger)($x$$3$$6, true, 6), (0, _Long.fromInteger)($x$$3$$6, true, 6)), BigNatModule$002EFFT$002EFp$$$p64)) >>> 0;
      n$$1 = ~~($n$$1$$7 / 2);
      continue BigNatModule$002EFFT$002EFp$$$mpow;
    } else {
      return (0, _Long.toInt)((0, _Long.op_Modulus)((0, _Long.op_Multiply)((0, _Long.fromInteger)(x$$3, true, 6), (0, _Long.fromInteger)(BigNatModule$002EFFT$002EFp$$$mpow((0, _Long.toInt)((0, _Long.op_Modulus)((0, _Long.op_Multiply)((0, _Long.fromInteger)(x$$3, true, 6), (0, _Long.fromInteger)(x$$3, true, 6)), BigNatModule$002EFFT$002EFp$$$p64)) >>> 0, ~~(n$$1 / 2)), true, 6)), BigNatModule$002EFFT$002EFp$$$p64)) >>> 0;
    }
...
function BigNatModule$002EFFT$002EFp$$$mpowL(x$$7, n$$2) {
  BigNatModule$002EFFT$002EFp$$$mpowL: while (true) {
    if ((0, _Long.equals)(n$$2, (0, _Long.fromBits)(0, 0, false))) {
      ...
      const $n$$2$$9 = n$$2;
      const $x$$7$$8 = x$$7;
      x$$7 = (0, _Long.toInt)((0, _Long.op_Modulus)((0, _Long.op_Multiply)((0, _Long.fromInteger)($x$$7$$8, true, 6), (0, _Long.fromInteger)($x$$7$$8, true, 6)), BigNatModule$002EFFT$002EFp$$$p64)) >>> 0;
      n$$2 = (0, _Long.op_Division)($n$$2$$9, (0, _Long.fromBits)(2, 0, false));
      continue BigNatModule$002EFFT$002EFp$$$mpowL;
    } else {
      return (0, _Long.toInt)((0, _Long.op_Modulus)((0, _Long.op_Multiply)((0, _Long.fromInteger)(x$$7, true, 6), (0, _Long.fromInteger)(BigNatModule$002EFFT$002EFp$$$mpowL((0, _Long.toInt)((0, _Long.op_Modulus)((0, _Long.op_Multiply)((0, _Long.fromInteger)(x$$7, true, 6), (0, _Long.fromInteger)(x$$7, true, 6)), BigNatModule$002EFFT$002EFp$$$p64)) >>> 0, (0, _Long.op_Division)(n$$2, (0, _Long.fromBits)(2, 0, false))), true, 6)), BigNatModule$002EFFT$002EFp$$$p64)) >>> 0;
    }
...
function BigNatModule$002EFFT$$$computeFFT(lambda, mu, n$$4, w, u, res, offset) {
  if (n$$4 === 1) {
    ...
    for (let j = 0; j <= halfN - 1; j++) {
      ...
      res[offset + j] = (even + ((0, _Long.toInt)((0, _Long.op_Modulus)((0, _Long.op_Multiply)((0, _Long.fromInteger)(wj, true, 6), (0, _Long.fromInteger)(odd, true, 6)), BigNatModule$002EFFT$002EFp$$$p64)) >>> 0)) % BigNatModule$002EFFT$002EFp$$$p;
      res[offsetHalfN + j] = (even + BigNatModule$002EFFT$002EFp$$$p - ((0, _Long.toInt)((0, _Long.op_Modulus)((0, _Long.op_Multiply)((0, _Long.fromInteger)(wj, true, 6), (0, _Long.fromInteger)(odd, true, 6)), BigNatModule$002EFFT$002EFp$$$p64)) >>> 0)) % BigNatModule$002EFFT$002EFp$$$p;
      wj = (0, _Long.toInt)((0, _Long.op_Modulus)((0, _Long.op_Multiply)((0, _Long.fromInteger)(w, true, 6), (0, _Long.fromInteger)(wj, true, 6)), BigNatModule$002EFFT$002EFp$$$p64)) >>> 0;
    }
  }
}
...
function BigNatModule$002EFFT$$$computeFftPaddedPolynomialProduct(bigK, k, u$$2, v) {
  ...
  const rT = (0, _Array.initialize)(n$$7, function (i$$2) {
    return (0, _Long.toInt)((0, _Long.op_Modulus)((0, _Long.op_Multiply)((0, _Long.fromInteger)(uT$$1[i$$2], true, 6), (0, _Long.fromInteger)(vT[i$$2], true, 6)), BigNatModule$002EFFT$002EFp$$$p64)) >>> 0;
  }, Uint32Array);
...
function BigNatModule$002EFFT$$$computeFftPolynomialProduct(degu, u$$4, degv, v$$1) {
  ...
  const rT$$1 = (0, _Array.initialize)(n$$9, function (i$$4) {
    return (0, _Long.toInt)((0, _Long.op_Modulus)((0, _Long.op_Multiply)((0, _Long.fromInteger)(uT$$2[i$$4], true, 6), (0, _Long.fromInteger)(vT$$1[i$$4], true, 6)), BigNatModule$002EFFT$002EFp$$$p64)) >>> 0;
  }, Uint32Array);
...
function BigNatModule$$$pow64(x$$23, n$$15) {
  BigNatModule$$$pow64: while (true) {
    if (n$$15 === 0) {
      ...
      const $n$$15$$11 = n$$15;
      const $x$$23$$10 = x$$23;
      x$$23 = (0, _Long.op_Multiply)($x$$23$$10, $x$$23$$10);
      n$$15 = ~~($n$$15$$11 / 2);
...
function BigNatModule$$$pow32(x$$24, n$$16) {
...
function BigNatModule$$$addP(i$$16, n$$25, c, p, q, r$$5) {
...
function BigNatModule$$$subP(i$$19, n$$26, c$$2, p$$2, q$$2, r$$7) {
...
function BigNatModule$$$contributeArr(a$$4, i$$25, c$$5) {
  BigNatModule$$$contributeArr: while (true) {
    ...
    const x$$38 = ~~(0, _Long.toInt)((0, _Long.op_BitwiseAnd)(x$$35, BigNatModule$$$baseMaski64)) | 0;
    a$$4[i$$25] = x$$38;
...
function BigNatModule$$$mulSchoolBookBothSmall(p$$15, q$$11) {
  ...
  BigNatModule$$$setCoeff(r$$11, 0, ~~(0, _Long.toInt)((0, _Long.op_BitwiseAnd)(rak, BigNatModule$$$baseMaski64)));
  BigNatModule$$$setCoeff(r$$11, 1, ~~(0, _Long.toInt)((0, _Long.op_Division)(rak, BigNatModule$$$baseNi64)));
  return BigNatModule$$$normN(r$$11);
}

function BigNatModule$$$mulSchoolBookCarry(r$$12, c$$8, k$$4) {
  BigNatModule$$$mulSchoolBookCarry: while (true) {
    if ((0, _Long.compare)(c$$8, (0, _Long.fromBits)(0, 0, false)) > 0) {
      ...
      BigNatModule$$$setCoeff(r$$12, k$$4, ~~(0, _Long.toInt)((0, _Long.op_BitwiseAnd)(rak$$1, BigNatModule$$$baseMaski64)));
      const $k$$4$$43 = k$$4;
      const $r$$12$$42 = r$$12;
      r$$12 = $r$$12$$42;
      c$$8 = (0, _Long.op_Division)(rak$$1, BigNatModule$$$baseNi64);
      k$$4 = $k$$4$$43 + 1;
...
function BigNatModule$$$mulSchoolBookOneSmall(p$$16, q$$12) {
  ...
  for (let i$$28 = 0; i$$28 <= bp - 1; i$$28++) {
    ...
    BigNatModule$$$setCoeff(r$$13, i$$28, ~~(0, _Long.toInt)((0, _Long.op_BitwiseAnd)(rak$$2, BigNatModule$$$baseMaski64)));
...
function BigNatModule$$$mulSchoolBookNeitherSmall(p$$17, q$$14) {
  ...
  for (let i$$29 = 0; i$$29 <= p$$17.bound - 1; i$$29++) {
    const pai$$1 = (0, _Long.fromInteger)(pa$$3[i$$29], false, 2);
    let c$$10 = (0, _Long.fromBits)(0, 0, false);
    let k$$5 = i$$29 | 0;

    for (let j$$1 = 0; j$$1 <= q$$14.bound - 1; j$$1++) {
      const qaj = (0, _Long.fromInteger)(qa$$3[j$$1], false, 2);
      const rak$$3 = (0, _Long.op_Addition)((0, _Long.op_Addition)((0, _Long.fromInteger)(ra[k$$5], false, 2), c$$10), (0, _Long.op_Multiply)(pai$$1, qaj));
      ra[k$$5] = ~~(0, _Long.toInt)((0, _Long.op_BitwiseAnd)(rak$$3, BigNatModule$$$baseMaski64));
...
function BigNatModule$$$scaleSubInPlace(x$$57, f, a$$5, n$$30) {
  ...
  while ((0, _Long.compare)(z$$7, (0, _Long.fromBits)(0, 0, false)) > 0 ? true : j$$4 < patternInput$$3[1]) {
    ...
    let zLo = ~~(0, _Long.toInt)((0, _Long.op_BitwiseAnd)(z$$7, BigNatModule$$$baseMaski64)) | 0;
    let zHi = (0, _Long.op_Division)(z$$7, BigNatModule$$$baseNi64);
...
function BigNatModule$$$scaleAddInPlace(x$$62, f$$3, a$$8, n$$32) {
  ...
  while ((0, _Long.compare)(z$$8, (0, _Long.fromBits)(0, 0, false)) > 0 ? true : j$$5 < patternInput$$5[1]) {
    ...
    let zLo$$1 = ~~(0, _Long.toInt)((0, _Long.op_BitwiseAnd)(z$$8, BigNatModule$$$baseMaski64)) | 0;
    let zHi$$1 = (0, _Long.op_Division)(z$$8, BigNatModule$$$baseNi64);
  ...
  if (patternInput$$6[1] < patternInput$$6[0] + n$$34) {
    ...
    if (patternInput$$6[0] === 0) {
      if (patternInput$$6[1] === n$$34) {
        ...
        const f64 = (0, _Long.op_Division)((0, _Long.op_Addition)((0, _Long.op_Multiply)((0, _Long.fromInteger)(patternInput$$7[1][patternInput$$6[1]], false, 2), BigNatModule$$$baseNi64), (0, _Long.fromInteger)(patternInput$$7[1][patternInput$$6[1] - 1], false, 2)), (0, _Long.fromInteger)(patternInput$$7[0][0], false, 2));
      ...
      const f64$$1 = (0, _Long.op_Division)((0, _Long.op_Addition)((0, _Long.op_Multiply)((0, _Long.fromInteger)(patternInput$$7[1][patternInput$$6[1]], false, 2), BigNatModule$$$baseNi64), (0, _Long.fromInteger)(patternInput$$7[1][patternInput$$6[1] - 1], false, 2)), (0, _Long.op_Addition)((0, _Long.fromInteger)(patternInput$$7[0][patternInput$$6[0]], false, 2), (0, _Long.fromBits)(1, 0, false)));
...
function BigNatModule$$$toUInt64(n$$44) {
  ...
  switch (matchValue$$1) {
    ...
    case 1:
      {
        return (0, _Long.fromInteger)(n$$44.digits[0], true, 2);
      }
...
function BigNatModule$$$toString(n$$45) {
  ...
  const route = function route(prior, k$$11, ten2k) {
    route: while (true) {
      if (BigNatModule$$$degree(ten2k) > degn) {
        ...
        prior = new _Types.List([$k$$11$$64, $ten2k$$65], $prior$$63);
        k$$11 = $k$$11$$64 + 1;
  ...
  const digits$$4 = collect(true, new _Types.List(), n$$45, prior$$2);

  if (digits$$4.tail == null) {
    return "0";
  } else {
    return (0, _String.join)("", ...(0, _Array.ofList)(digits$$4, Array));
  }
}
