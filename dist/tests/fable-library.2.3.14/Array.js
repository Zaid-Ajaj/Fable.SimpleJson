...
function groupBy(projection$$2, array$$25, cons$$11, eq$$5) {
  ...
  for (let idx$$3 = 0; idx$$3 <= array$$25.length - 1; idx$$3++) {
    ...
    const matchValue$$4 = (0, _Util.tryGetValue)(dict$$1, key$$1, null);

    if (matchValue$$4[0]) {
      dict$$1.set(key$$1, new _Types.List(v, matchValue$$4[1]));
    } else {
      (0, _Util.addToDict)(dict$$1, key$$1, new _Types.List(v, new _Types.List()));
      keys.push(key$$1);
    }
  }

  const result$$5 = new Array(keys.length);
  (0, _Seq.iterateIndexed)(function action(i$$14, key$$2) {
    result$$5[i$$14] = [key$$2, cons$$11.from((0, _Util.getItemFromDict)(dict$$1, key$$2)).reverse()];
  }, keys);
  return result$$5;
}
...
function find(predicate$$11, array$$55) {
  ...
  if (matchValue$$5 == null) {
    ...
    const res$$5 = (0, _Option.value)(matchValue$$5);
    return res$$5;
  }
}
    ...
    loop$$1: while (true) {
      if (i$$24 >= array$$63.length) {
        ...
        if (matchValue$$8 != null) {
          const res$$6 = (0, _Option.value)(matchValue$$8);
          return res$$6;
        } else {
          const $i$$24$$88 = i$$24;
          i$$24 = $i$$24$$88 + 1;
  ...
  const loop$$4 = function loop$$4(i$$27) {
    loop$$4: while (true) {
      if (i$$27 < 0) {
        ...
        return (0, _Option.some)(array$$66[i$$27]);
      } else {
        const $i$$27$$97 = i$$27;
        i$$27 = $i$$27$$97 - 1;
        continue loop$$4;
...
function choose(chooser$$2, array$$70, cons$$30) {
  ...
  const g = function g(x$$5) {
    return (0, _Option.value)(chooser$$2(x$$5));
  };
...
function tryHead(array$$94) {
  if (array$$94.length === 0) {
    ...
    return (0, _Option.some)(array$$94[0]);
  }
}
...
function tryItem(index$$6, array$$98) {
  if (index$$6 < 0 ? true : index$$6 >= array$$98.length) {
    ...
    return (0, _Option.some)(array$$98[index$$6]);
  }
}
...
function toList(source$$10) {
  ...
  for (let i$$51 = len$$20 - 1; i$$51 >= 0; i$$51--) {
    target$$7 = new _Types.List(source$$10[i$$51], target$$7);
  }
...
function windowed(windowSize, source$$11) {
  ...
  const res$$10 = new Array((0, _Util.max)(_Util.comparePrimitives, 0, source$$11.length - windowSize));
