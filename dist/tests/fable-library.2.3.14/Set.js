  ...
  SetTreeModule$$$collapseLHS: while (true) {
    if (stack.tail != null) {
      if (stack.head.tag === 2) {
        ...
        stack = new _Types.List(l$$19, new _Types.List(SetTreeModule$$$SetOne(k$$29), new _Types.List(r$$19, rest$$1)));
...
function SetTreeModule$002EmkIEnumerator$00601$reflection($gen$$49) {
  return (0, _Reflection.type)("Set.SetTreeModule.mkIEnumerator`1", [$gen$$49]);
}
      ...
      default:
        {
          ...
          m$$8 = l$$20;
          acc$$10 = new _Types.List(k$$31, SetTreeModule$$$loop(r$$20, $acc$$10$$64));
...
function FSharpSet$reflection($gen$$68) {
  return (0, _Reflection.type)("Set.FSharpSet", [$gen$$68]);
}
